...
type
  ...
  private
    ...
    function CalculaFatorial(iNumber: integer): integer;
    procedure Limpar;
...
begin
  ...
  begin
    iResultFatorial := CalculaFatorial(StrToInt(edtInput.Text));
...
function TfrmFatorial.CalculaFatorial(iNumber: integer): integer;
var
  i: integer;
  n: integer;
begin
